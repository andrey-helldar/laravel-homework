...
Для других фреймворков - использовать дамп БД `dump.sql`
...
- страницу на которой выводится текущая температура в Брянске (запрос из php) (например: https://tech.yandex.ru/weather/)
